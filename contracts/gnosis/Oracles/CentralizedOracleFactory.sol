...
contract CentralizedOracleFactory {
     ...
     *  Events
     */
    event CentralizedOracleCreation(address indexed creator, CentralizedOracle centralizedOracle, bytes32 ipfsHash);
    ...
    function createCentralizedOracle(bytes32 ipfsHash)
        public
